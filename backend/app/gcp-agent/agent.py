...
def _make_langfuse_config() -> dict[str, Any] | None:
    ...
    """
    # Only enable when keys are present.
...
def _build_langchain_mcp_tools(
    *,
    ...
    for tool_name, meta in tool_catalog.items():
        ...
        def _make_fn(_tool_name: str) -> Callable[[str | None], str]:
            def _fn(project_id: str | None = None) -> str:
                args: dict[str, Any] = {}
                if project_id:
...
def node_plan_tools(
    ...
    *,
    ...
    prompt = (
        ...
        "- Use empty arguments {} unless project_id is explicitly requested.\n"
        f"{allow_empty_note}"
    ...
    *,
    ...
    system = SystemMessage(
        content=(
            ...
            "- If evidence is insufficient, return [] instead of guessing.\n"
